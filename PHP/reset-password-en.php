...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["confirm_password"]))){
        ...
        if(empty($new_password_err) && ($new_password != $confirm_password)){
            $confirm_password_err = "La confirmación de contraseña no coincide.";
        }
    }
...
<head>
    ...
    <style>
        ...
        .wrapper{ width: 360px; padding: 20px; border-radius: 15px; background-color: #fff;}
    </style>
</head>
<body background="esq.png" style="background-repeat: no-repeat;">
    ...
    <div class="wrapper">
        ...
        <p>Please fill in the following if you wish to change your password.</p>
