  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form3 class="d-flex">
         ...
         <a href="logout-en.php" class="btn btn-secondary btn-sm">Cerrar Sesión</a>
      </form3>
...
====-->
    ...
    <li><i class="icono fas fa-building"></i> Nivel de formación profesional: <?php echo $field17name?></li>
        ...
        <br>
                        <p>
        <a href="reset-password-en.php" class="btn btn-secondary">Actualizar contraseña</a>
        <a href="logout-en.php" class="btn btn-info">Cerrar sesión</a>
    </p>
    </section>
